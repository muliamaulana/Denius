...
public class TechnologyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycler_tech);
        categoryAdapter = new CategoryAdapter();
        LinearLayoutManager layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(categoryAdapter);
        swipeRefreshLayout = view.findViewById(R.id.refresh_tech);
    ...
    private void loadNews() {
        ...
        Call<Headlines> headlinesCall = newsInterface.getCategory("id", "technology", BuildConfig.API_KEY);
...
//            Toast.makeText(context, "Technology Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
