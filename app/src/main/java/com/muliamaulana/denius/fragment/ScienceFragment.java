...
public class ScienceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycler_sci);
        categoryAdapter = new CategoryAdapter();
        LinearLayoutManager layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(categoryAdapter);
        swipeRefreshLayout = view.findViewById(R.id.refresh_sci);
    ...
    private void loadNews() {
        ...
        Call<Headlines> headlinesCall = newsInterface.getCategory("id", "science", BuildConfig.API_KEY);
...
//            Toast.makeText(context, "Science Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
