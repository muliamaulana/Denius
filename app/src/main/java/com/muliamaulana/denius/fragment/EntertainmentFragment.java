...
public class EntertainmentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycler_entertainment);
        categoryAdapter = new CategoryAdapter();
        LinearLayoutManager layoutManager = new LinearLayoutManager(context);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(categoryAdapter);
        swipeRefreshLayout = view.findViewById(R.id.refresh_entertainment);
    ...
    private void loadNews() {
        ...
        Call<Headlines> headlinesCall = newsInterface.getCategory("id", "entertainment", BuildConfig.API_KEY);
...
//            Toast.makeText(context, "Entertainment Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
