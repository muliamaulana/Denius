...
public class HealthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout = view.findViewById(R.id.refresh_health);
    ...
    private void loadNews() {
        ...
        Call<Headlines> headlinesCall = newsInterface.getCategory("id", "health", BuildConfig.API_KEY);
...
//            Toast.makeText(context, "Health Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
