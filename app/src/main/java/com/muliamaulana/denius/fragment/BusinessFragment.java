...
import com.muliamaulana.denius.adapter.HeadlinesAdapter;
...
public class BusinessFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        swipeRefreshLayout = view.findViewById(R.id.refresh_business);
    ...
    private void loadNews() {
        ...
        Call<Headlines> headlinesCall = newsInterface.getCategory("id", "business",BuildConfig.API_KEY);
...
//            Toast.makeText(context, "Business Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
